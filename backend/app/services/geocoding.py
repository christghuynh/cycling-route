...
Photon (OpenStreetMap-based) is used rather than the OpenRouteService geocoder because it
resolves street addresses such as "330 Phillip Street, Waterloo" that the ORS geocoder misses.
It needs no API key. For heavy use, Photon is self-hostable and the client only needs a new
base URL.
"""
